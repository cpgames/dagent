...
// Re-export branch naming functions from shared types
// These are the canonical implementations per DAGENT_SPEC section 8.1
export { getFeatureBranchName, getTaskBranchName } from '@shared/types/feature'
